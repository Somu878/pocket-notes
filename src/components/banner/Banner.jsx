...
function Banner() {
  return (
    <div className='banner' style={{background:'#DAE5F5',width:'72vw',height:'100%',marginTop:'-6px',cursor:'default'}}>
      <div style={{display:'flex',flexDirection:'column',justifyContent:'center',alignItems:'center',paddingTop:'280px'}}>
